...
class ModelValidationTests(unittest.TestCase):
    def test_cli_catalog_models_are_all_validator_approved(self):
        for provider, models in get_known_models().items():
            if provider in ("ollama", "openrouter", "vllm", "litellm"):
                continue
    ...
    def test_proxy_and_local_providers_accept_custom_models_without_warning(self):
        for provider in ("openrouter", "ollama", "vllm", "litellm"):
